	...
	<body>
		...
		<div id="list-livre" class="content scaffold-list" role="main">
			...
			<table>
				<thead>
					<tr>
						...
						<th><g:message code="livre.shoppingItem.label" default="Shopping Item" /></th>
				...
				<g:each in="${livreInstanceList}" status="i" var="livreInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${livreInstance.id}">${fieldValue(bean: livreInstance, field: "shoppingItem")}</g:link></td>
			...
			<div class="pagination">
				<g:paginate params="${params}" } total="${livreInstanceTotal}" />
			</div>
		</div>
	</body>
</html>
